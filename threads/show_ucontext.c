...
main(int argc, char **argv)
{
	...
	printf("memory address of the program counter (RIP) saved in mycontext = 0x%lx\n",
	...
	printf("number of bytes between err and the saved stack in mycontext = %ld\n", (unsigned long)((int *)mycontext.uc_mcontext.gregs[REG_RSP]-&err)*-1);
